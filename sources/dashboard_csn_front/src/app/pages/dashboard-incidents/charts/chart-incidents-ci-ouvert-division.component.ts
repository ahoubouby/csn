...
@Component({
  selector: 'ngx-chart-incidents-ci-ouvert-division-semaine',
  template: `
  <chart type="bar" [data]="data" [options]="options"></chart>
  `,
})
export class ChartIncidentsCiOuvertDivisionComponent implements AfterViewInit, OnDestroy, OnInit {
  incidents = [];
  days = [];
  data: any;
  options: any;
  ...
  constructor(private theme: NbThemeService,
    ...
    this.onLoadIncidentsCiOuvertDivisionSemaine();
  ...
  onLoadIncidentsCiOuvertDivisionSemaine() {
    this.service.getIncidentsCiOuvertDivisionSemaine()
